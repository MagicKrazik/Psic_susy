document.addEventListener('DOMContentLoaded', function() {
    ...
    const serviceDescriptions = {
        ...
        'job-search': 'Elegir una carrera es una decisión importante que influye en muchos aspectos de tu vida. La orientación te ayudará a conocer tus fortalezas, intereses y tomar decisiones informadas en beneficio de tu futuro.',
